...
from .models import TokenResponse, User, UserLogin, UserStatus
...
class AuthManager:
    ...
    def authenticate_user(
        self, username: str, password: str, users_db: Dict[str, User]
    ...
    def login(
        self, login_data: UserLogin, users_db: Dict[str, User]
        ...
        user, error = self.authenticate_user(
            login_data.username, login_data.password, users_db
        )
    ...
    def refresh_access_token(
        self, refresh_token: str, users_db: Dict[str, User]
...
class TokenManager:
    ...
    def get_current_user(self, token: str, users_db: Dict[str, User]) -> Optional[User]:
        """
    ...
    def require_auth(
        self, token: str, users_db: Dict[str, User]
    ) -> Tuple[Optional[User], Optional[str]]:
        """
