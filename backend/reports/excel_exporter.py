...
from .models import ReportChart, ReportData, ReportMetrics, ReportTable
    ...
    def _create_metrics_sheet(self, metrics: ReportMetrics):
        ...
        metrics_data = [
            (
                ...
                "Good" if metrics.safety_score >= 80 else "Needs Improvement",
            ),
            (
                "Total Incidents",
                metrics.total_incidents,
                metrics.trend_direction.capitalize(),
            ),
            ...
            (
                ...
                "Good" if metrics.compliance_rate >= 90 else "Action Required",
            ),
