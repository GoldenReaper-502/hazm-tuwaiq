...
from .models import GeneratedReport, ReportFrequency, ScheduledReport
...
class ReportScheduler:
    ...
    def _create_trigger(self, schedule: ScheduledReport) -> CronTrigger:
        ...
        if schedule.frequency == ReportFrequency.DAILY:
            ...
            day_of_week = (
                schedule.day_of_week if schedule.day_of_week is not None else 0
            )
    ...
    def get_scheduler_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "active_schedules": sum(
                1 for s in self.scheduled_reports.values() if s.is_active
            ),
