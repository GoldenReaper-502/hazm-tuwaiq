...
class EnhancedAutonomousResponse:
    ...
    def process_incident(self, incident: Incident) -> List[AutonomousAction]:
        ...
        selected_actions = self._select_optimal_actions(
            incident, possible_actions, response_level
        )
        ...
        autonomous_actions = [
            a for a in selected_actions if a.response_level == ResponseLevel.AUTONOMOUS
        ]
    ...
    def _determine_response_level(self, incident: Incident) -> ResponseLevel:
        ...
        if incident.confidence < 0.7:
            ...
            levels = [
                ...
                ResponseLevel.ASSIST,
                ResponseLevel.EXECUTE,
                ResponseLevel.AUTONOMOUS,
            ]
            ...
            if "equipment" in incident.incident_type.lower():
                actions.append(
                    AutonomousAction(
                        ...
                        priority=10,
                        estimated_execution_time=self.response_times[
                            ActionType.STOP_EQUIPMENT
                        ],
            ...
            if "fire" in incident.incident_type.lower():
                actions.append(
                    AutonomousAction(
                        ...
                        priority=10,
                        estimated_execution_time=self.response_times[
                            ActionType.ACTIVATE_SAFETY_SYSTEM
                        ],
    ...
    def _select_optimal_actions(
        ...
        filtered_actions = [
            a for a in possible_actions if self._is_action_allowed(a, response_level)
        ]
    ...
    def _is_action_allowed(
        self, action: AutonomousAction, max_level: ResponseLevel
    ) -> bool:
    ...
    def _generate_rationale(
        self, incident: Incident, selected_actions: List[AutonomousAction]
    ) -> str:
