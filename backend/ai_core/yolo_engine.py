...
class YOLOEngine:
    ...
    def __init__(
        self, model_path: str = "yolov8n.pt", confidence_threshold: float = 0.25
    ):
        """
    ...
    def _load_model(self) -> bool:
        ...
        try:
            ...
            if not model_file.exists():
                self.logger.info(
                    f"Model not found at {self.model_path}, downloading YOLOv8n..."
                )
    ...
    def _analyze_ppe_compliance(self, detections: Dict[str, Any]) -> Dict[str, Any]:
        ...
        compliance_rate = (
            min(detected_ppe / expected_ppe, 1.0) if expected_ppe > 0 else 0.0
        )
